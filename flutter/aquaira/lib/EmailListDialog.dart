...
class MyDialogForm2 extends StatefulWidget {
  final String variable;
  final String idM;
  final Function() onDeleteSuccess;
  final String catogory;

  MyDialogForm2({required this.variable, required this.idM, required this.onDeleteSuccess(), required this.catogory});
  @override
  _MyDialogForm2State createState() => _MyDialogForm2State();
}

class _MyDialogForm2State extends State<MyDialogForm2> with SingleTickerProviderStateMixin {
  ...
  Future<void> createEmailList(String id) async {
    final url = 'http://localhost:3000/api/emails/createList/$id'; // Replace with your API endpoint
