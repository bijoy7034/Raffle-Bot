...
class MyDialogTasks extends StatefulWidget {
  final String variable;

  MyDialogTasks({required this.variable});
  @override
  _MyDialogFormState createState() => _MyDialogFormState();
}

class _MyDialogFormState extends State<MyDialogTasks> with SingleTickerProviderStateMixin {
