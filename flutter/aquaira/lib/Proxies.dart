...
class Proxies extends StatefulWidget {
  @override
  _ProfilesState createState() => _ProfilesState();
}

class _ProfilesState extends State<Proxies> {
  List<Group> groups = [];
  ...
  Future<void> fetchData() async {
    ...
    final groupResponse = await http.get(
      Uri.parse('http://localhost:3000/api/proxies/all'),
    ...
    final emailResponse =
    await http.get(Uri.parse('http://localhost:3000/api/proxies/list/all'));
    final emailData =
