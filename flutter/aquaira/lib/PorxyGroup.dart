...
class MyDialogProxyGroup extends StatefulWidget {
  @override
  _MyDialogFormState createState() => _MyDialogFormState();
}

class _MyDialogFormState extends State<MyDialogProxyGroup> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      ...
      child: AlertDialog(
        ...
        title: const Text('New Proxy Group', style: TextStyle(color: Colors.orange),),
        content: Container(
          width: 500,
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(filled: true,
                            fillColor: Colors.grey[850], labelText: 'Proxy Group Name', focusedBorder: const OutlineInputBorder(
